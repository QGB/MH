...
public class PickerShellTableSort extends JFrame {
	public static Boolean csb_IsTest=true;

	static PickerShellTableSort frame;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new PickerShellTableSort();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
...
//		getContentPane().add(txt_word);
		...
		gridBagLayout.setConstraints(btn, gbc);
