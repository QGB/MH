...
public class Entry extends Object {
	...
	public final Translations trans = new Translations("");
	public final Sentences sentces = new Sentences();
	//public ArrayList<Senten> alSes=new ArrayList<Senten>();
	public final Inflection inflection = new Inflection();
	public final Usually usually = new Usually();
	...
	public class Setting{
		public boolean gbIsFromDB = false;
	}
